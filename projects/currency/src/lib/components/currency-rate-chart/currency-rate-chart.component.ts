...
import { ICbrCurrency } from '../../entities/cbr-currency';
import { CbrCurrencyRate } from '../../entities/cbr-currency-rate';
import { CbrCurrencyRateDynamicService } from '../../services/cbr-currency-rate-dynamic/cbr-currency-rate-dynamic.service';
import { CbrCurrencyService } from '../../services/cbr-currency/cbr-currency.service';

@Component({
  selector: 'lib-currency-rate-chart',
