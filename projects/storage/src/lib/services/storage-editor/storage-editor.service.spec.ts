...
export const storageEditorServiceSpy = () => {
  ...
  const spy = jasmine.createSpyObj('StorageEditorService', ['getNodeEditor', 'getHelpPageId']);
...
describe('StorageEditorService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [StorageEditorService, StorageNodeToExtPipe],
    });
