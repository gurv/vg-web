...
export const copyPasteServiceSpy = () =>
  // eslint-disable-next-line jasmine/no-unsafe-spy
  jasmine.createSpyObj('CopyPasteService', [
    'cut',
    'copy',
    'paste',
    'isCut',
...
describe('CopyPasteService', () => {
  ...
  it('should copy / paste', () => {
    ...
    const req = httpTestingController.expectOne(
      (request) => request.method === 'POST' && request.url === 'backendApiUrl/files/copy',
    );
  ...
  it('should cut / paste', () => {
    ...
    const req = httpTestingController.expectOne(
      (request) => request.method === 'POST' && request.url === 'backendApiUrl/files/move',
    );
