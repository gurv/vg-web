...
import { SSEService } from 'projects/commons/src/lib/sse/services/sse/sse.service';
import { sseServiceSpy } from 'projects/commons/src/lib/sse/services/sse/sse.service.spec';
...
import { testStorageNodesSorted } from '../storage-tree-data-source/storage-tree-data-source.service.spec';
...
export const storageListServiceSpy = () => {
  ...
  const spy = jasmine.createSpyObj('StorageListService', ['init', 'ngOnDestroy']);
  ...
  describe('after init', () => {
    ...
    beforeEach(() => {
      nodes = [
        ...
        {
          path: 'reports/report2/report.json',
          type: 'FILE',
          depth: 2,
          length: 42,
          lastModified: 1337,
      ...
      node = {
        path: 'reports/report3/report.json',
        type: 'FILE',
        depth: 2,
        length: 42,
        lastModified: 1337,
