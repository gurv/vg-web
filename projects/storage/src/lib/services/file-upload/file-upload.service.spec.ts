...
import { testErrorEvent } from 'projects/commons/src/lib/config/entities/rest-server-error.spec';

export const fileUploadServiceSpy = () => {
  // eslint-disable-next-line jasmine/no-unsafe-spy
  const spy = jasmine.createSpyObj('FileUploadService', ['upload']);
...
describe('FileUploadService', () => {
  ...
  it('should upload file', () => {
    ...
    const values = [];
    service
      ._uploadFile({ name: 'filename' } as any, 'endpoint')
