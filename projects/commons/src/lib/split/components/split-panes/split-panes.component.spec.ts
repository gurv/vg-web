...
import { SplitPanesModule } from './split-panes.module';
...
@NgModule({
  imports: [CoreTestModule, SplitPanesModule],
...
describe('SplitPanesComponent', () => {
  ...
  //   expect(component.drag).toEqual(new SplitDrag(42, 0, 1, 20, 30, 1337, 1337));
  // });
  ...
  //   expect(component.drag).toEqual(new SplitDrag(42, 0, 2, 20, 50, 1337, 1337));
  // });
  ...
  it('should cursorDragged', () => {
    component.drag = new SplitDrag(500, 0, 1, 20, 30, 1000, 1000);
  ...
  it('should cursorDragged fail because of min size left', () => {
    component.drag = new SplitDrag(1000, 0, 1, 20, 30, 1000, 1000);
  ...
  //   expect(TestBed.inject(WindowService).resize).toHaveBeenCalledWith();
  // });
