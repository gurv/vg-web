...
import { Configuration } from 'projects/commons/src/lib/config/entities/configuration';
import { ENVIRONMENT } from 'projects/commons/src/lib/config/entities//configuration-environment';
...
export class ConfigurationService {
  ...
  constructor(private http: HttpClient, @Inject(ENVIRONMENT) private env) {}
