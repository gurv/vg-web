...
import { RouterProgressModule } from './router-progress.module';
...
describe('RouterProgressComponent', () => {
  ...
  beforeEach(
    waitForAsync(() => {
      TestBed.configureTestingModule({
        imports: [VendorsModule, CoreTestModule, RouterProgressModule],
  ...
  it('should update loading state false (2)', fakeAsync(() => {
    router.events = of(
      new NavigationEnd(null, null, null),
      new NavigationCancel(null, null, null),
      new NavigationError(null, null, null),
