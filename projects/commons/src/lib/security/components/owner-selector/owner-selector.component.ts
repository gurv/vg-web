...
import { OwnerType } from 'projects/commons/src/lib/security/entities/owner-type';
    ...
    switch (type) {
      ...
      case 'APPLICATION':
        this.formGroup.addControl(
          'applicationId',
          new FormControl(this._owner.applicationId, [Validators.required]),
        );
        this.formGroup.removeControl('userId');
        break;
      case 'USER':
        ...
        this.formGroup.addControl(
          'userId',
          new FormControl(this._owner.userId, [Validators.required]),
        );
        break;
    }
  }
