...
export const localStorageServiceSpy = () => {
  ...
  spy.getString.and.callFake((key: string, defaultValue?: any) => defaultValue);
  spy.getNumber.and.callFake((key: string, defaultValue?: any) => defaultValue);
  spy.getBoolean.and.callFake((key: string, defaultValue?: any) => defaultValue);
  spy.getItem.and.callFake((key: string, defaultValue?: any) => defaultValue);
  return spy;
};
